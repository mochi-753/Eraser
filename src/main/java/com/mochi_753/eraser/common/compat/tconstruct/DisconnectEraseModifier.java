...
public class DisconnectEraseModifier extends NoLevelsModifier implements MeleeHitModifierHook, ProjectileHitModifierHook {
    @Override
        ...
        if (!context.getLevel().isClientSide() && tool.hasTag(TinkerTags.Items.MELEE_PRIMARY)) {
            ...
            if (victim instanceof Player victimPlayer) {
                ...
                if (context.getAttacker() instanceof Player player) {
                    ...
                    EraserUtils.disconnectPlayer(victimPlayer);
                }
            } else {
